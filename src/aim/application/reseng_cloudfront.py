...
from aim.stack_group import StackOrder
...
class CloudFrontResourceEngine(ResourceEngine):
    ...
    def init_resource(self):
        for factory_name, factory_config in self.resource.factory.items():
            cloudfront_config_ref = self.resource.aim_ref_parts + '.factory.' + factory_name
            ...
            cert_config = self.aim_ctx.get_ref(self.resource.viewer_certificate.certificate)
