...
@click.command('backup', short_help='Triggers a backup of a resource.')
...
@click.argument('config_resource', required=False, type=click.STRING)
@pass_context
def cli(aim_ctx, controller_type, component_name=None, config_name=None, config_region=None, config_resource=None):
    ...
    #    config_name
    #)
    aim_ctx.log("Backing up resource in: %s.%s", controller_type, component_name )
